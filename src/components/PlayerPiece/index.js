...
const SVG = ({
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} id="svg3128"
version="1" transform={transform}>
    <g id="layer1" >
        ...
        id="path3194" fill={fill} stroke="#000" strokeWidth="1.5" strokeLinecap="round"
        strokeDashoffset="10" />
    </g>
</svg>
);
